...
await it('is built', async () =>
  deepStrictEqual(
    JSON.stringify(Object.entries(await import('@halospv3/hce.shared-config/semanticReleaseConfig')), undefined, 2),
    JSON.stringify(Object.entries(await import('../src/semanticReleaseConfig.js')), undefined, 2),
  ),
)
